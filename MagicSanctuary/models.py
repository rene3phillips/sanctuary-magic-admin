...
class Habitat(models.Model):
    ...
    magic_level = models.IntergerField()
...
class Creature(models.Model):
    ...
    abilities = models.ManyToManyField(SpecialAbility, through ='CreatureAbility')
...
class CreatureAbilities(models.Model):
    ...
    proficiency_level = models.IntergerField(null=True, blank=True)
